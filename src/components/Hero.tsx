      ...
      <div className="mx-auto max-w-8xl px-5 sm:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="animate-fade-up">
            <p className="eyebrow">
              Mission Khoj · Student-Led Initiative
            </p>
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-ink-200 sm:text-lg">
              We help students discover scholarships, competitions, research
              programs, learning opportunities and more — opportunities that
              often exist beyond the classroom.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-ink-400">
              ...
              <span className="inline-flex items-center gap-1.5">
                <GraduationCap className="h-3.5 w-3.5 text-gold-400/70" />
                Built for students
              </span>
...
function DiscoveryVisual() {
  return (
    <div className="relative h-full w-full">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="relative h-[340px] w-[340px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <Compass
              className="h-12 w-12 text-gold-400/40 animate-pulse-glow"
              strokeWidth={1}
            />
          </div>
        </div>
      ...
      >
        <path
          d="M60 440 C120 360, 100 280, 180 220 S280 120, 340 60"
          stroke="url(#pathGrad)"
          strokeWidth="1.5"
          strokeDasharray="4 6"
        />
      ...
      {/* Decorative stars */}
      <Star
        className="absolute right-16 top-4 h-3 w-3 fill-gold-400/40 text-gold-400/40 animate-pulse-glow"
        aria-hidden="true"
      />

      <Star
        className="absolute bottom-24 left-20 h-2.5 w-2.5 fill-gold-400/30 text-gold-400/30 animate-pulse-glow"
